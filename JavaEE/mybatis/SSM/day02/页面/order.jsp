		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
					...
					<form id="orderForm" action="${pageContext.request.contextPath }/orderServlet?action=createOrder" method="post">
										...
										<tr>
											...
											<table cellspacing="1" class="carttable">
												...
												<table width="100%" border="0" cellspacing="0">
													...
													<tr>
														<td width="10%"><img style="width:30px;height:30px;" alt="" src="${entry.value.product.pimage }"></td>
